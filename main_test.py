...
from models.network_srmt import SRMT as net
...
def main():
    ...
    parser.add_argument('--scale', type=int, default=4, help='scale factor: 2, 3, 4')
    parser.add_argument('--model_path', type=str, default='./pretrained_models/SRMT_X4.pth', help='pertrained_models for X2, X3, X4')
    parser.add_argument('--folder_lq', type=str, default='', help='Set5 Set14 BSD100 Urban100')
...
def define_model(args):
    model = net(upscale=args.scale, in_chans=3, img_size=64, window_size=8,
                img_range=1., depths=[6, 6, 6, 6], embed_dim=60, num_heads=[6, 6, 6, 6], mlp_ratio=2)
    param_key_g = 'params'
